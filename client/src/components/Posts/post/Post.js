...
const Post = ({post, setCurrentId}) => {
    ...
    return (
      ...
      <CardMedia className={classes.media} image={post.selectedFile || 'https://www.solidbackgrounds.com/images/1024x600/1024x600-black-solid-color-background.jpg'} amount={post.amount} />
